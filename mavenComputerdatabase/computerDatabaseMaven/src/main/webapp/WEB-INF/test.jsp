...
<body>
    <header class="navbar navbar-inverse navbar-fixed-top">
        <div class="container">
            <a class="navbar-brand" href="DashboardServlet.java"> Application - Computer Database </a>
        </div>
    </header>
    ...
    <section id="main">
        <div class="container">
            <h1 id="homeTitle">
            <c:out value="${pcList.size()}" /> Computers found
            </h1>
                	...
                	<c:when test="${! empty pcList}" >
                		<c:forEach var="pc" items="${pcList}">
                			<tr>
                        		...
                        		<c:set var="company" value="${pc.companyDTO}" />
